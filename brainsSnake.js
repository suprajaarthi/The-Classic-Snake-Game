...
function draw(){
	if (screen == 1) {
		...
		var my_gradient=canvasContext.createLinearGradient(0, 0, 800, 0);
		...
		canvasContext.font = "90px Comic Sans MS";
	...
	if (screen == 2) {
		...
		var my_gradient=canvasContext.createLinearGradient(0, 0, 800, 0);
		my_gradient.addColorStop(0,"black");
		my_gradient.addColorStop(0.5, "aqua");
		my_gradient.addColorStop(1, "silver");
	...
	if (screen == 3) {		
		...
		var my_gradient=canvasContext.createLinearGradient(0, 0, 800, 0);
		my_gradient.addColorStop(0, "violet");
